...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002107248021'))
    ...
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', 'geeteshh7'))
    if 'DYNO' in environ:
        ON_HEROKU = True
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://MONGOO:<password>@cluster0.kquc5py.mongodb.net/?retryWrites=true&w=majority'))
